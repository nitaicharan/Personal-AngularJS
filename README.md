...
<p align="center">:bangbang: Documentation available to access at: https://nitaicharan.github.io/Personal-AngularJS :bangbang:</p>

<!--[![](PREVIEW.png)](https://nitaicharan.github.io/Udemy-CCDNJSMDB1/)-->
<a href="https://nitaicharan.github.io/Personal-AngularJS">
  <p align="center">
    <img src="PREVIEW.png">
  </p>
</a>
...
This project was part of my personal study about the JavaScript-based open-source front-end web framework AngularJS is.
...
git push origin `git subtree split --prefix <directory> main`:gh-pages --force
```
